...
test("validates the current curriculum and resource packages", async () => {
  ...
  assert.equal(result.counts.lessons, 70);
  assert.equal(result.counts.digitalEntryPoints, 44);
  assert.equal(result.counts.applets, 18);
  assert.equal(result.counts.manimClips, 4);
  ...
  assert.ok(result.resources.some((resource) => resource.id === "SH-HS-MATH-HJ-B2-C07-L03-A02"));
  assert.ok(result.resources.some((resource) => resource.id === "SH-HS-MATH-HJ-B2-C07-L04-A01"));
  assert.ok(result.resources.some((resource) => resource.id === "SH-HS-MATH-HJ-B2-C07-L05-A01"));
  assert.ok(result.resources.some((resource) => resource.id === "SH-HS-MATH-HJ-B2-C07-L06-A01"));
  assert.ok(result.resources.some((resource) => resource.id === "SH-HS-MATH-HJ-B2-C07-L07-A01"));
  ...
  assert.ok(result.resources.some((resource) => resource.id === "SH-HS-MATH-HJ-B1-C02-L04-A01"));
  assert.ok(result.resources.some((resource) => resource.id === "SH-HS-MATH-HJ-B1-C02-L05-A01"));
  assert.ok(result.resources.some((resource) => resource.id === "SH-HS-MATH-HJ-B1-C04-L06-A01"));
  assert.ok(result.resources.some((resource) => resource.id === "SH-HS-MATH-HJ-B2-C06-L03-A01"));
  ...
  assert.ok(result.resources.some((resource) => resource.id === "SH-HS-MATH-HJ-B2-C08-L04-M01"));
