...
- 审核线：第 8 章 L01-L04 与 L05/L10/L04-M01 的两批审核报告都已合入总控，L05/L10/L04-M01 的首轮质量修复、修复后复核、平台入口闸门修复和小范围质量闸门复核也已合入。L05 触控热区与资源内布局自检通过，L10 可进入 `math_review` 队列但仍保留 `hold_for_platform_iframe_fit`，L04-M01 保持 `video_ready` 预览入口。下一步仍不应立刻扩大生产，而应继续处理 `L10-A01` 平台 iframe fit、`L05-A01` 真实触控/教师试读和 `L04-M01` 教师观看节奏；第 8 章教材目录未终核前，不恢复发布链路。
