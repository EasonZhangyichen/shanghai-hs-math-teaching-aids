...
- [ ] 从 `content/production/resource-backlog.json` 中选择下一个 MVP item，优先推进 `SH-HS-MATH-HJ-B2-C07-L05-D01` 或渲染复核 `SH-HS-MATH-HJ-B2-C07-L05-M01`。
...
- [x] 生成 `content/production/resource-backlog.json`，覆盖必修第二册第 7 章 15 个资源工作单元；当前 6 个已实现、9 个待创建。
