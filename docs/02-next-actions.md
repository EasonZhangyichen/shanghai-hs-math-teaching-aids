...
- [ ] 在第 6 章终核后，决定是否调整第 7 章先修节点、B2-C06 planned resource 和 backlog；第 9 章复数等承接节点仍需展开。
...
- [x] 生成 `content/production/resource-backlog.json`，覆盖必修第二册第 6、7、8 章共 30 个资源工作单元；当前 25 个已实现、5 个待创建，其中第 6 章 5 个 planned 候选需等待纸质教材或 dolearning 终核后再 scaffold。
